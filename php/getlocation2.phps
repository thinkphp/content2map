...
<div id="doc" class="yui-t7">
   <div id="hd" role="banner"><h1>Analyse a text and add map with its locations in pure JavaScript</h1></div>
   <div id="bd" role="main">
	<div class="yui-g">
   ...
   <div id="ft" role="contentinfo"><p>Written by Adrian Statescu | <a href="getlocation2.phps">source</a> | <a href="controller2.phps">controller2.php</a></p></div>
</div>
</body>
</html>
